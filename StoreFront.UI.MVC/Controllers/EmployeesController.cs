...
namespace StoreFront.UI.MVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,Title,DirectReportID,DepartmentID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,Title,DirectReportID,DepartmentID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
